  ...
  return (
    ...
    >
      <Button
        ...
        className="relative rounded-full bg-muted items-center flex p-0 px-0.5"
      ...
      >
        ...
        <div
          className={cn(
            "absolute size-8 p-2 rounded-full duration-150 [view-transition-name:dark-mode] motion-reduce:transition-none",
            colorScheme !== "dark"
